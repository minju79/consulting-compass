...
export const routeMeta: Record<string, RouteMeta> = {
  ...
  "/showcase/nadoo-ai": {
    path: "/showcase/nadoo-ai",
    title: `실전 사례: NADOO.AI | ${industryConfig.tagline}`,
    description: "부동산·소상공인 AI 자동화 컨설팅사 NADOO.AI의 홈페이지 제작 사례 분석 및 구조 미리보기.",
    ogTitle: "실전 사례: NADOO.AI",
    ogDescription: "부동산·소상공인 AI 자동화 컨설팅사 NADOO.AI의 실무 사례 분석.",
    ogType: "article",
    ogImage: OG_IMAGE,
    robots: "index, follow",
    schemaType: "Article",
    searchIntent: "실전 사례 분석 — 컨설팅 사이트 기획과 구조",
    keywords: ["NADOO.AI", "AI 자동화", "컨설팅 홈페이지 사례"],
    navTitle: "실전 사례: NADOO.AI",
    navOrder: 9,
    icon: "Sparkles",
    group: "guide",
    breadcrumbLabel: "NADOO.AI 사례",
  },
  "/client-brief": {
    path: "/client-brief",
